...
namespace EnhancedUI.EnhancedScroller
{
    ...
    public class EnhancedScroller : MonoBehaviour
    {
            ...
            )
        {
            ...
            if (StartDataIndex == 0 && EndDataIndex == (NumberOfCells - 1))
            {
        ...
        public void Snap()
        {
	        ...
	        int cellNum = NumberOfCells;
            _snapDataIndex = _snapCellViewIndex % cellNum;

			if (_scrollRect.movementType == ScrollRect.MovementType.Elastic)
			{
				if (_snapDataIndex == cellNum - 1)
				{
					JumpToDataIndex(_snapDataIndex, 1f, 1f, snapUseCellSpacing, snapTweenType, snapTweenTime, SnapJumpComplete);
				}
				else
				{
			...
			//Debug.LogErrorFormat("{0} {1}/{2} Snap", _snapDataIndex, _snapCellViewIndex, cellNum);
		}
        ...
        {
            for (var i = _recycledCellViews.Count - 1; i >= 0; i--)
            {
