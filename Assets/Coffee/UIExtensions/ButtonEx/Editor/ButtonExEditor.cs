...
using EventType = Coffee.UIExtensions.ButtonEx.EventType;
using System.Linq;
...
namespace Coffee.UIExtensions.Editors
{
    ...
    public class ButtonExEditor : SelectableEditor
    {
        ...
        protected override void OnEnable()
        {
            ...
            {
                { EventType.Select,serializedObject.FindProperty("m_OnSelect") },
            ...
            callbackDrawers = new Dictionary<EventType, System.Action>()
            {
                ...
                },
                {
                    ...
                    () =>
                    {
                        ...
                        EditorGUILayout.PropertyField(eventProperties[EventType.Select]);
                    }
                },
				//ホールド.
				{
